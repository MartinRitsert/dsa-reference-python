...
- Type hints from `typing` (`Any`) and PEP 604 union syntax (`X | None`) are used on method signatures and instance variables. Local variables are not annotated unless the type is complex or non-obvious.
